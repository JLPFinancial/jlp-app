/**
 * Supabase Edge Function: super-handler
 *
 ...
 *   https://gxwwcrcllhaaoewgcbeo.supabase.co/functions/v1/super-handler
 */
...
Deno.serve(async (req: Request) => {
  ...
  const loanSummary = [
    ...
    app.fin_type ?? app.finType ? `Finance type: ${app.fin_type ?? app.finType}` : "",
  ...
  const ghlPayload = {
    ...
    application_id: app.app_id ?? app.id ?? "",
